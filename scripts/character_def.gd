...
const DEFS := {
	...
	LI: {
		...
		"job": "三线带货主播(直播间黄了)",
		"role": "范围控场",
		"quote": "家人们点开链接!全网最低价就在脚下——先到先得,别走那么快!",
		"skill": "全网最低价",
		"skill_cd": 24.0,
		"skill_line": "原地投放促销链接,周围所有对手被吸引减速",
		"skill_desc": [
			"原地发布半径 6 米的直播间促销链接,持续 8 秒",
			"范围内其他玩家与NPC移速/推车速度 -45%",
			"李洋本人不受自己发布的促销区影响",
			"可封锁货架口、收银通道或掩护自己抢货撤离",
			"代价:发布时自身 +20 失衡",
		],
		"passive": "爆款嗅觉",
